<template>
	<div class="body" style="background-color: #EEEEEE; width: ;">
		<div class="header">
			...
			<div class="comm-head">
				...
				<div class="head-userinfo-normal">
					<div class="head-userinfo-avatar">
						<img :src='userimg' width="36" height="auto" alt="玩家头像">
						<span></span>
		...
		<div class="gbox">
			<div class="box1">
				<div class="box1left">
					<div class="lunbo">
						<Carousel  autoplay='true' autoplay-speed='2000'>
							<CarouselItem>
					...
					<div class="activite" style="margin-top: 40px;">
						<div style="width: 5px; height: 25px; background-color: #1da6ba; margin-bottom: -38px;"></div>
						<Tabs value="name2">
							<TabPane label="热门活动" name="name1" disabled>

							</TabPane>
							<TabPane label="正在进行" name="name2">
								<ul id="J_actListContainer">
									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1560407187_uploadnewsImg.jpg" alt="幸运六月" width="180"
										 height="193">
										<p>幸运六月</p>
										...
										<a class="herf-mask" href="https://lol.qq.com/act/a20190601Dragonfist/index.html?e_code=477299" target="_blank"
										 title="幸运六月" onclick="pgvSendClick({hottag:'v3.index.action.9758'})"></a>
									</li>

									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1560395797_uploadnewsImg.jpg" alt="星魂集结集卡" width="180"
										 height="193">
										<p>星魂集结集卡</p>

										<a class="overtime">12天后结束</a>
										...
										<div class="innerhover-border">
											<i class="hover-border-1"></i>
											<div class="innerhover-border-inner">
												<h4 class="p1">星魂集结集卡</h4>
												

											</div>
										</div>
										<a class="herf-mask" href="http://lol.qq.com/act/a20190527starcode/index.html?e_code=478574" target="_blank"
										 title="星魂集结集卡" onclick="pgvSendClick({hottag:'v3.index.action.9807'})"></a>
									</li>

									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1559825635_uploadnewsImg.jpg" alt="甜咸大战" width="180"
										 height="193">
										<p>甜咸大战</p>

										<a class="overtime">10天后结束</a>
										...
										<a class="herf-mask" href="https://lol.qq.com/act/a20190604dragonboat/index.html?e_code=478027" target="_blank"
										 title="甜咸大战" onclick="pgvSendClick({hottag:'v3.index.action.9792'})"></a>
									</li>

									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1558937674_uploadnewsImg.jpg" alt="LPL夏季赛售票开启" width="180"
										 height="193">
										<p>LPL夏季赛售票开启</p>

										<a class="overtime">65天后结束</a>


										<div class="innerhover-border">
											<i class="hover-border-1"></i>
											<div class="innerhover-border-inner">
												<h4 class="p1">LPL夏季赛售票开启</h4>
												

											</div>
										</div>
										<a class="herf-mask" href="https://lpl.qq.com/es/ticket.shtml?e_code=452420" target="_blank" title="LPL夏季赛售票开启"
										 onclick="pgvSendClick({hottag:'v3.index.action.9730'})"></a>
									</li>
								</ul>
							</TabPane>
							<TabPane label="商城特惠" name="name3">
								<ul id="J_actListContainer">
									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1559719024_uploadnewsImg.jpg" alt="周边魔法屋" width="180"
										 height="193">
										<p>周边魔法屋</p>

										<a class="overtime">6天后结束</a>


										<div class="innerhover-border">
											<i class="hover-border-1"></i>
											<div class="innerhover-border-inner">
												<h4 class="p1">周边魔法屋</h4>
												
											</div>
										</div>
										<a class="herf-mask" href="https://lolriotmall.qq.com/act/a20190530magic/page1.html?ADTAG=lolriotmall.pc.lolhdzx.ad&amp;e_code=477649"
										 target="_blank" title="周边魔法屋" onclick="pgvSendClick({hottag:'v3.index.action.9771'})"></a>
									</li>

									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1559717240_uploadnewsImg.jpg" alt="小恶魔 崔丝塔娜" width="180"
										 height="193">
										<p>小恶魔 崔丝塔娜</p>
										...
										<div class="innerhover-border">
											<i class="hover-border-1"></i>
											<div class="innerhover-border-inner">
												<h4 class="p1">小恶魔 崔丝塔娜</h4>
												

											</div>
										</div>
										<a class="herf-mask" href="https://lol.qq.com/act/skinstation/index.html?e_code=477636" target="_blank" title="小恶魔 崔丝塔娜"
										 onclick="pgvSendClick({hottag:'v3.index.action.9770'})"></a>
									</li>

									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1559876500_uploadnewsImg.jpg" alt="每周5折" width="180"
										 height="193">
										<p>每周5折</p>
										...
										<a class="herf-mask" href="https://daoju.qq.com/mall/tao.shtml?flag=lol&amp;e_code=451191" target="_blank"
										 title="每周5折" onclick="pgvSendClick({hottag:'v3.index.action.9797'})"></a>
									</li>

									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1557991118_uploadnewsImg.jpg" alt="战斗学院" width="180"
										 height="193">
										<p>战斗学院</p>
										...
										<a class="herf-mask" href="https://lol.qq.com/act/a20190510battle/index.html?e_code=474918" target="_blank"
										 title="战斗学院" onclick="pgvSendClick({hottag:'v3.index.action.9689'})"></a>
									</li>
								</ul>
							</TabPane>
							<TabPane label="长期活动" name="name4">
								<ul id="J_actListContainer">
									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1559531368_uploadnewsImg.jpg" alt="福来Day" width="180"
										 height="193">
										<p>福来Day</p>
										...
										<div class="innerhover-border">
											<i class="hover-border-1"></i>
											<div class="innerhover-border-inner">
												<h4 class="p1">福来Day</h4>
												

											</div>
										</div>
										<a class="herf-mask" href="https://lol.qq.com/act/a20190403koifish/index.html?e_code=469976" target="_blank"
										 title="福来Day" onclick="pgvSendClick({hottag:'v3.index.action.9520'})"></a>
									</li>

									<li class="act-item">
										<img src="//ossweb-img.qq.com/images/clientpop/act/lol_1554279028_uploadnewsImg.jpg" alt="《校园解说大赛》等你发声！"
										 width="180" height="193">
										<p>《校园解说大赛》等你发声！</p>
										...
										<div class="innerhover-border">
											<i class="hover-border-1"></i>
											<div class="innerhover-border-inner">
												<h4 class="p1">《校园解说大赛》等你发声！</h4>
												

											</div>
										</div>
										<a class="herf-mask" href="https://www.ccel.org.cn/loljs" target="_blank" title="《校园解说大赛》等你发声！" onclick="pgvSendClick({hottag:'v3.index.action.7795'})"></a>
									</li>

									<li class="act-item">
										<img src="http://ossweb-img.qq.com/images/clientpop/act/lol_1539328710_uploadnewsImg.jpg" alt="高校自发赛" width="180"
										 height="193">
										<p>高校自发赛</p>
										...
										<div class="innerhover-border">
											<i class="hover-border-1"></i>
											<div class="innerhover-border-inner">
												<h4 class="p1">高校自发赛</h4>
												

											</div>
										</div>
										<a class="herf-mask" href="https://lpl.qq.com/es/lcl/zf/?e_code=443488" target="_blank" title="高校自发赛" onclick="pgvSendClick({hottag:'v3.index.action.8758'})"></a>
									</li>

									<li class="act-item">
										<img src="http://ossweb-img.qq.com/images/clientpop/act/lol_1537548023_uploadnewsImg.jpg" alt="作者入驻计划" width="180"
										 height="193">
										<p>作者入驻计划</p>
										...
										<div class="innerhover-border">
											<i class="hover-border-1"></i>
											<div class="innerhover-border-inner">
												<h4 class="p1">作者入驻计划</h4>
												
											</div>
										</div>
										<a class="herf-mask" href="http://kol.qq.com/?e_code=440515" target="_blank" title="作者入驻计划" onclick="pgvSendClick({hottag:'v3.index.action.8679'})"></a>
									</li>
								</ul>
							</TabPane>
						</Tabs>
				...
				<div class="box1right">
					<div class="newlist">
						<Tabs>
							<TabPane label="综合" name="name5">
								<ul style="width: 100%; display: flex; flex-flow: column; justify-content: center;">
									<li v-for='item in newsdata' :key='item.newssrc' style="margin-left: 20px; list-style: none; ">
										<div style="width: 100%; height: 1px; background-color: #e0e2e2; margin: 11px 0;"></div>
										<div style=" display: flex; flex-flow: nowrap; align-items: center;">
											<span class="item-type">{{item.newstype}}</span>
											<a class="item-href">
												{{item.newsname}}
											</a>
											<p class="item-time">{{item.newstime}}</p>
										</div>

									</li>
								</ul>
							</TabPane>
							<TabPane label="公告" name="name6">
<ul style="width: 100%; display: flex; flex-flow: column; justify-content: center;">
									<li v-for='item in newsdata' :key='item.newssrc' style="margin-left: 20px; list-style: none; ">
										<div style="width: 100%; height: 1px; background-color: #e0e2e2; margin: 11px 0;"></div>
										<div style=" display: flex; flex-flow: nowrap; align-items: center;">
					...
					<div class="gamebtn">
						<div class="oneline" style="display: flex;">
							<video class="side-down-video" autoplay="" loop="" muted="" width="330" height="168" style="margin-top: -6px;">
								<source src="//ossweb-img.qq.com/images/lol/v3/btn-download.mp4" type="video/mp4">
							</video>
							<div class="oneline-t" style="float: right;">
								<img src="../assets/新手必备.png" style="float: right;" />
								<img src="../assets/领取中心.png" style="float: right; margin-top:6px" />
							</div>
						</div>
						<div class="twoline" style="display: flex; justify-content: space-between;">
							<img src="../assets/在线客服.png" />
							<img src="../assets/秩序殿堂.png" />
							<img src="../assets/游戏资料.png" />
							<img src="../assets/峡谷之巅.png" />
						</div>
						<div class="threeline" style="display: flex; justify-content: space-between; margin-top: 8px;">
							<img src="../assets/绑定微信.png" width="222" />
							<img src="../assets/LOL宇宙.png" />
							<img src="../assets/玩家社区.png" />
						</div>
					</div>
				</div>
			</div>
			<div class="box2">
				<div style="width: 100%;display: flex;align-items: center; margin-left: 40px;margin-bottom: -30px;margin-top: 20px;">
					<div style="width: 5px; height: 28px;background-color: #1da6ba; margin-right: 10px;line-height:20px;"></div>
					<h2 style="font-size: 24px; font-weight: 400; color: #000000;">英雄</h2>
				</div>
				<div class="herolist">
			...
			<div class="box3">
				...
				<div class="box3left">
					<div style="width: 100%; display: flex;flex-flow: row;align-items: center; margin-bottom: 30px;">
						<div style="width: 5px; height: 25px; background-color: #1da6ba; margin-bottom: -5px;"></div>
						<h2 style="font-size: 24px; font-weight: 400; width: 100%; height: 28px; text-align:left; margin-left: 10px;">FANART创作馆</h2>
					</div>
					<div style=" display: flex;">
					<ul class="fanart-left-content">
						<li>
							<a href="//tr.lol.qq.com/fanart/detail.html?contentId=67082" target="_blank" title="战斗学院拉克丝" onclick="pgvSendClick({hottag:'v3.index.fanart.67082'});">
								<img class="fanart-img" id="fanart0" src="http://shp.qpic.cn/cms_pic/1341050461/4dd28d9e5459565bc88f85cf4dd3952b/258"
								 alt="战斗学院拉克丝">
							</a>
							<!--hover-->
						...
						<li>
							<a href="//tr.lol.qq.com/fanart/detail.html?contentId=67081" target="_blank" title="战斗学院阿狸" onclick="pgvSendClick({hottag:'v3.index.fanart.67081'});">
								<img class="fanart-img" id="fanart1" src="//shp.qpic.cn/cms_pic/1367004737/6c7d7fbe71352ddef2562fca389745ed/258"
								 alt="战斗学院阿狸">
							</a>
							<!--hover-->
						...
						<li>
							<a href="//tr.lol.qq.com/fanart/detail.html?contentId=67079" target="_blank" title="学院讲师—迦娜" onclick="pgvSendClick({hottag:'v3.index.fanart.67079'});">
								<img class="fanart-img" id="fanart2" src="http://shp.qpic.cn/cms_pic/1347061822/723f58e3939b0b45a6a27710e5d69229/258"
								 alt="学院讲师—迦娜">
							</a>
							<!--hover-->
						...
						<li>
							<a href="//tr.lol.qq.com/fanart/detail.html?contentId=67078" target="_blank" title="战斗学院 迦娜" onclick="pgvSendClick({hottag:'v3.index.fanart.67078'});">
								<img class="fanart-img" id="fanart3" src="http://shp.qpic.cn/cms_pic/1340045838/0f9dd217d51bb4a7af0f0e31aa80d9e6/258"
								 alt="战斗学院 迦娜">
							</a>
							<!--hover-->
						...
						<li>
							<a href="//tr.lol.qq.com/fanart/detail.html?contentId=67072" target="_blank" title="卡特琳娜" onclick="pgvSendClick({hottag:'v3.index.fanart.67072'});">
								<img class="fanart-img" id="fanart4" src="http://shp.qpic.cn/cms_pic/1341032936/c80ff2e53589e2349a58c6d32a4f6bd5/258"
								 alt="卡特琳娜">
							</a>
							<!--hover-->
						...
						<li>
							<a href="//tr.lol.qq.com/fanart/detail.html?contentId=67064" target="_blank" title="战斗学院·霸道师姐，蔚" onclick="pgvSendClick({hottag:'v3.index.fanart.67064'});">
								<img class="fanart-img" id="fanart5" src="http://shp.qpic.cn/cms_pic/1346015485/170ac36f25be2d8af724e09b307a03c3/258"
								 alt="战斗学院·霸道师姐，蔚">
							</a>
							<!--hover-->
						...
						<li>
							<a href="//tr.lol.qq.com/fanart/detail.html?contentId=67063" target="_blank" title="持刀的艾希女皇" onclick="pgvSendClick({hottag:'v3.index.fanart.67063'});">
								<img class="fanart-img" id="fanart6" src="http://shp.qpic.cn/cms_pic/1000909452/0b15daa1841e03c971742f93bc2d70b7/258"
								 alt="持刀的艾希女皇">
							</a>
							<!--hover-->
						...
						<li>
							<a href="//tr.lol.qq.com/fanart/detail.html?contentId=67060" target="_blank" title="战斗学院阿狸人设" onclick="pgvSendClick({hottag:'v3.index.fanart.67060'});">
								<img class="fanart-img" id="fanart7" src="http://shp.qpic.cn/cms_pic/1342049076/2862cb4a623241890e3f382fa3fd0fb4/258"
								 alt="战斗学院阿狸人设">
							</a>
							<!--hover-->
				...
				<div class="box3right">
					<img class="jiaoni" src="../assets/教你一招.png" height="405" style="margin-top:15px"/>
					<div class="right-btn" >
						<img src="../assets/用户调查.png" />
						<img src="../assets/见证.png" />
						<img src="../assets/品牌.png"/>
						<img src="../assets/合作媒体.png" />
					</div>
